/*
  ...
  - Added the required column `regionId` to the `JobListing` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_JobListing" ("address", "city", "createdAt", "description", "id", "jobCategoryId", "organisationId", "title", "userId", "workHome", "workType", "zipcode") SELECT "address", "city", "createdAt", "description", "id", "jobCategoryId", "organisationId", "title", "userId", "workHome", "workType", "zipcode" FROM "JobListing";
