/*
  ...
  - You are about to drop the `workTypeModel` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the column `workType` on the `JobListing` table. All the data in the column will be lost.
  - You are about to drop the column `workTypeModelId` on the `JobListing` table. All the data in the column will be lost.
  - Added the required column `workTypeId` to the `JobListing` table without a default value. This is not possible if the table is not empty.

*/
-- DropTable
PRAGMA foreign_keys=off;
DROP TABLE "workTypeModel";
...
INSERT INTO "new_JobListing" ("address", "city", "createdAt", "description", "id", "jobCategoryId", "organisationId", "regionId", "title", "userId", "workHome", "zipcode") SELECT "address", "city", "createdAt", "description", "id", "jobCategoryId", "organisationId", "regionId", "title", "userId", "workHome", "zipcode" FROM "JobListing";
